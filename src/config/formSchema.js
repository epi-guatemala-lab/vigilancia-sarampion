...
export const formFields = [
  ...
  {
    id: 'area_salud_mspas',
    label: 'Departamento de la unidad',
    type: 'text',
    page: 1,
    required: true,
    colSpan: 'half',
    sectionTitle: 'Ubicación de la Unidad Notificadora',
    readOnly: true,
    helpText: 'Auto-completado según la unidad médica seleccionada arriba.',
  },
  {
    id: 'distrito_salud_mspas',
    label: 'Municipio de la unidad',
    type: 'text',
    page: 1,
    required: true,
    colSpan: 'half',
