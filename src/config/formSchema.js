...
export const formFields = [
  ...
  },
  {
    ...
    page: 2,
    required: false,
    options: ['Madre', 'Padre', 'Abuelo/a', 'Tío/a', 'Hermano/a', 'Otro'],
    colSpan: 'half',
  },
  {
    id: 'tipo_id_tutor',
  ...
  },
  {
    ...
    page: 6,
    required: false,
    placeholder: 'Departamento (si fue dentro de Guatemala)',
    conditional: { dependsOn: 'viajo_7_23_previo', showWhen: 'SI' },
    colSpan: 'half',
    validation: { maxLength: 60 },
  },
  ...
  // Secuenciación
  {
    ...
    page: 8,
    required: false,
    placeholder: 'Genotipo o resultado de secuenciación genómica',
    colSpan: 'half',
